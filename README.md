...
> ⚠️ **Note:** The model weights cannot be shared at this time due to internal IP restrictions. We plan to release an open version of the model weights in the future, following peer-reviewed publication.
