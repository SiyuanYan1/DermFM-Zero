...
# Normalization: default ImageNet; DermFM-Zero (v15) uses CLIP-style (0.5,0.5,0.5)
# via env vars (set by the DermFM-Zero VQA shells).
...
print(f"[VQA dataloader] normalization mean={mean} std={std}")
