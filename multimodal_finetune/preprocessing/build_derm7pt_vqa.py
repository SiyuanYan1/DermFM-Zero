...
Outputs the artefacts under
    data/multimodal_finetune/derm7pt-VQA/meta/{train,val,test}.csv
...
def main():
    ...
    ap.add_argument('--meta_csv',
                    default=str(repo_root / 'data' / 'derm7pt' / 'meta' / 'meta.csv'),
                    help='Source derm7pt meta CSV.')
    ap.add_argument('--image_root',
                    default='../data/derm7pt/images',
    ...
    ap.add_argument('--output_dir',
                    default=str(repo_root / 'data' / 'multimodal_finetune' / 'derm7pt-VQA' / 'meta'))
    ap.add_argument('--case_split', default=None,
